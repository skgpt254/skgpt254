...
User controls: name, repo, description, tags, order (array order).
Auto-fetched:  stars, languages (byte split, used for the top-language bar), pushed_at.
If the API fails for a repo (e.g. renamed/private/not yet created), the card
still renders using only the config data.
"""
import json
import os
import sys
...
def gh(url):
    req = urllib.request.Request(url, headers={
        ...
        "User-Agent": "profile-projects-panel",
    })
